# ファイル名: step5-A_density_filter.py (サマリー表示版)
...
if __name__ == '__main__':
    ...
    if len(rebar_indices) == 0:
        ...
        exit()
    rebar_points = points[rebar_indices]
    ...
    o3d.visualization.draw_geometries([result_pcd, axis], window_name="Step5-A: AFTER Filtering", width=1600, height=1200)