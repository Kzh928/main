...
ANNOTATION_TARGET_BOX = [
    1468.6048530098703, 3325.5580689490807,  # Xの範囲
    -1339.0, -1108.0,  # Yの範囲
    -1324.6191400962468, 967.098327912479   # Zの範囲
]

# --- 他の設定項目 ---
# ★★★ ファイル名を新しいものに変更 ★★★
LABELS_FILE_PATH = 'annotated_labels_negatives_CA.npy'
OUTPUT_DATASET_FILE = 'training_dataset_negatives_CA.pkl'
# ★★★ ここまで ★★★
