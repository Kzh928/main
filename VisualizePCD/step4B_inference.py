# ファイル名: step4_inference.py (v2モデル使用版)
...
PCD_PATH = 'work_area.csv' # または 'work_area.csv,work_area_large.csv' など、試したいファイル
NUM_NEIGHBORS = 64
...
if __name__ == '__main__':
    ...
    # 新しい予測結果を保存する
    np.save('predicted_labels_f06110053.npy', pred_labels)
    print("新しい予測結果を 'predicted_labels_f06110053.npy' に保存しました。")