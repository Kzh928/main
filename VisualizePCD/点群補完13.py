# 生成日: 2025-06-24
# 目的: Repulsion Lossを加えて学習させた、最終版の点群補完AIの性能を
#       視覚的にテスト・評価する。
# ファイル名: D4_test_repulsion_model.py
...
# --- ★★★ ユーザー設定項目 ★★★ ---
MODEL_PATH = 'repulsion_model.pth' # C4で作成した最新モデル
DATASET_PATH = 'multidensity_additive_dataset.pkl' # A4で作成した最新データセット
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for i, (input_32_tensor, missing_32_truth_tensor) in enumerate(test_samples):
            ...
            pcd_generated.paint_uniform_color([1, 0, 0]); pcd_generated.translate((X_SPACING, y_offset, 0))
            ...
            pcd_truth.paint_uniform_color([0, 1, 0]); pcd_truth.translate((X_SPACING * 2, y_offset, 0))
    ...
    o3d.visualization.draw_geometries(
        geometries_to_draw,
        window_name=f"{NUM_SAMPLES_TO_SHOW} Repulsion Model Test Results",
