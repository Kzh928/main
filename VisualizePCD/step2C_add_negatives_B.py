...
TARGET_BOX = [
    1248.9896462136005, 2822.2668365980926,  # Xの範囲
    -1224.0, 1613.0,  # Yの範囲
    -1369.7836841932626, -1060.410106975718   # Zの範囲
]


# 保存するアノテーションファイル（.npy）の名前
OUTPUT_LABELS_PATH = 'annotated_labels_negatives_CB.npy'
# 出力する学習データセットのファイル名
OUTPUT_DATASET_PATH =  'training_dataset_negatives_CB.pkl'
