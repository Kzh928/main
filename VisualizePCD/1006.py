...
LABELS_PATH = 'annotated_labels_3class_final_robust_1004.npy'
...
LEARNING_RATE = 0.001
OUTPUT_MODEL_PATH = 'pointnet_model_3class_final_robust_1004.pth' # ◀◀◀【変更推奨】モデル名を変更
LOG_FILE_PATH = 'training_log_final_robust_1004.csv' # ◀◀◀【変更推奨】ログファイル名を変更
