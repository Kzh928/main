...
LABELS_TO_MERGE = [
    ...
    ('labels_for_equipment_1010_B.npy', 'equipment_area1010_B.csv'),
    ('labels_for_equipment_1010.npy', 'equipment_area1010.csv'),
...
# 結合後の出力ファイル名
OUTPUT_LABELS_PATH = 'annotated_labels_3class_final_robust_1010.npy'
