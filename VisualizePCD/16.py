# ファイル名: step10.3_final_pipeline_rearmost_plane.py
# 概要: 「最も奥にある鉄筋群」から仮想平面を算出し、それを基準にはつり範囲を特定する、
#       最終改良版パイプライン。
...
# ... (step10.1と同じPointNetモデル定義と壁面検出関数をここにコピーしてください) ...
...
if __name__ == '__main__':
    ...
    # ▼▼▼【新パラメータ】最も奥の鉄筋平面を特定するためのしきい値 (mm) ▼▼▼
    ...
    o3d.visualization.draw_geometries([pcd_wall_only], window_name="最終結果(1/2): 詳細分類 (最奥平面版)")
    ...
    o3d.visualization.draw_geometries([pcd_wall_only], window_name="最終結果(2/2): はつり範囲 (最奥平面版)")
