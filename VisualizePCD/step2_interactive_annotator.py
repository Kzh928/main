# ファイル名: step2_interactive_annotator.py
...
WORK_AREA_CSV_PATH = 'work_area.csv' 
...
ANNOTATION_TARGET_BOX = [
    3110.5650755138686, 3370.356671661414,  # Xの範囲
    -344.0, 748.0,  # Yの範囲
    -1174.2859956728362, -844.3084479405359   # Zの範囲
]


# --- 他の設定項目 ---
LABELS_FILE_PATH = 'annotated_labels.npy'  # ラベル作業の保存/読み込み先
OUTPUT_DATASET_FILE = 'training_dataset.pkl' # 最終的な学習データセットの保存先
