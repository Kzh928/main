...
#       最後に、最も奥の鉄筋の平均深度を基準に「はつり範囲」を特定・可視化する。
...
if __name__ == '__main__':
    ...
    # --- はつり範囲判定用パラメータ ---
    REARMOST_PLANE_THRESHOLD = 50.0 # 最も奥の鉄筋と見なすための厚み(mm)
    ...
    print("\n次に「削る/削らない」のシンプルな判断結果（3色）を表示します。")
