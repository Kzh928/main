# ファイル名: step2_add_negatives.py 追加分　床のみ
...
ANNOTATION_TARGET_BOX = [
    1731.1913840225204, 2402.0771754743723,  # Xの範囲
    -195.0, 323.0,  # Yの範囲
    -1299.6509146234976, -1158.4150343837002   # Zの範囲
]

# --- 他の設定項目 ---
# ★★★ ファイル名を新しいものに変更 ★★★
LABELS_FILE_PATH = 'annotated_labels_negatives.npy'
OUTPUT_DATASET_FILE = 'training_dataset_negatives.pkl'
# ★★★ ここまで ★★★
