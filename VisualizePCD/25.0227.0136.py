...
# --- 反射強度のフィルタリング（0以下と100以上を除外） ---
filtered_data = filtered_data[(filtered_data[:, 3] > 0) & (filtered_data[:, 3] < 100)]
...
intensity_bins = [20] + list(np.linspace(20, 100, len(custom_colors) - 1))
