...
LABELS_TO_MERGE = [
    ...
    ('annotated_labels_4class_A.npy', 'equipment_area1010_B.csv'),
    ('annotated_labels_4class_B.npy', 'equipment_area1010.csv'),
    ('annotated_labels_4class_C.npy', 'equipment_area1001.csv'),
    ('annotated_labels_4class_D.npy', 'equipment_area3.csv'),
    ('annotated_labels_4class_J.npy', 'work_area_large.csv'),
    ('annotated_labels_4class_H.npy', 'work_area_large.csv'),
    ('annotated_labels_4class_G.npy', 'work_area_large.csv'),
    ('annotated_labels_4class_F.npy', 'work_area_large.csv'),
    ('annotated_labels_4class_E.npy', 'work_area.csv'),
    ('annotated_labels_4class_1020C.npy','equipment_area1020C.csv'),
    ('annotated_labels_4class_1020B.npy','equipment_area1020B.csv'),
    ('annotated_labels_4class_1020A.npy','equipment_area1020A.csv'),
    ('annotated_labels_4class_1020.npy','equipment_area1020.csv'),
...
# 結合後の出力ファイル名
OUTPUT_LABELS_PATH = 'annotated_labels_4class.npy'
