# 生成日: 2025-06-24 13:15
# 目的: 低密度な点群データを入力とし、点群補完AIで高密度化し、
#       その後に鉄筋検出AIで分析、最後に後処理を行う、
#       一連のエンドツーエンドの推論パイプライン。
# ファイル名: final_pipeline.py
...
if __name__ == '__main__':
    ...
    # ご指示通り、座標軸は表示しない
    o3d.visualization.draw_geometries([final_pcd], window_name="Final End-to-End Pipeline Result", width=1600, height=1200)
